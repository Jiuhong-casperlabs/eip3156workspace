...
export const PATH_TO_CONTRACT_BORROW = `${process.env.HOME}/mywork/eip3156workspace/eip3156-1/target/wasm32-unknown-unknown/release/br-contract.wasm`;
// Path to lend contract
export const PATH_TO_CONTRACT_LEND = `${process.env.HOME}/mywork/eip3156workspace/eip3156-1/target/wasm32-unknown-unknown/release/ld-contract.wasm`;
